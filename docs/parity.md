...
directory, so those absences are this renderer's and not artifacts of measuring
too high. `drawParagraph` is the clear case in the other direction — the
