...
| `aiks_dl_runtime_effect_unittests.cc` | — | 4 | bounded by having one fixture program rather than by the renderer |
| `aiks_dl_unittests.cc` | ~39 | 7 | mostly internal optimizations and picture round-trips |

The catalog holds one hundred and eighty-five scenes of roughly four hundred,
